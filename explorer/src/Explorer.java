...
public class Explorer {
	public static void main(String args[]) throws UnsupportedOperationException, NumberFormatException, IOException {//메인 메소드. IO, 숫자 포맷, 지원하지 않는 작업 관련 Exception 처리
		...
		private static Component makeTree(Component root) throws UnsupportedOperationException {//디렉토리 루트를 이용하여 트리 생성 메소드
		...
		private static void fileList(Component root) throws UnsupportedOperationException, NumberFormatException, IOException {
